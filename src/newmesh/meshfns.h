...
namespace NEWMESH {
  ...
  double calculate_triangular_strain(const Triangle&, const Triangle&, const double&, const double&, const bool& calc_emery = false, const boost::shared_ptr<ColumnVector>& indexSTRAINS = boost::shared_ptr<ColumnVector>(), const bool& legacy_strain = false, const bool& piecewise_strain = false);

  double calculate_triangular_strain(int, const NEWMESH::newmesh&, const NEWMESH::newmesh&, const double&, const double&, const bool& calc_emery = false, const boost::shared_ptr<ColumnVector>& indexSTRAINS = boost::shared_ptr<ColumnVector>(), const bool& legacy_strain = false, const bool& piecewise_strain = false);

  double triangle_strain(const Matrix&, const Matrix&, const double&, const double&, const boost::shared_ptr<ColumnVector>& strains = boost::shared_ptr<ColumnVector>(), const bool& emery_strain = false, const bool& legacy_strain = false, const bool& piecewise_strain = false);
